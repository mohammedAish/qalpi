...
<style>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5 pt-5" id="kt_content">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--label-right" method="post" action="{{ route('archive.status',$application->id)}}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="kt-portlet__body">
                    <div class="row">
                        ...
                        <div class="tab-pane px-2 pt-5" id="attachments">
                            ...
                            <div class="col-md-4 py-2  my-3 col-sm-12 px-2">
                                <label for="username" class="form-label">ملفات المريض</label>
                                 <a href="#" class="pop">
                                @if($application->files_patients != NULL)

                                @if(pathinfo($application->files_patients)
                                 ['extension']=='pdf')

                                      <embed type="application/pdf" src="{{asset('img/'.$application->files_patients)}}" width="100%" height="300px" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html" background-color="0xFF525659" top-toolbar-height="56" full-frame="" internalinstanceid="21" title="CHROME">
                                    @else
                                    <img src="{{asset('img/'.$application->files_patients)}}" style="width:90%; height:200px;">
                                    @endif
                                    @endif
                                  </a>
                            </div>
