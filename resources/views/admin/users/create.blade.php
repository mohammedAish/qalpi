                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <input type="text" value="{{ old('name') }}" name="name" id="title" class="form-control @error('name') is-invalid @enderror" placeholder="االاسم">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <input type="text" value="{{ old('email') }}" name="email" id="title" class="form-control @error('email') is-invalid @enderror" placeholder="البريد الالكتروني">
                            @error('email')
                            <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
